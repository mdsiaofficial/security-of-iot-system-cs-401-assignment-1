...
\vspace*{0.5cm}
{\LARGE\bfseries City University}\par
\vspace*{0.1cm}
{\large Khagan, Birulia, Savar, Dhaka}\par
\vspace{2em}
{\large\bfseries Faculty of Science and Engineering}\par
{\large\bfseries Department of Computer Science and Engineering (CSE)}\par
\vspace{4.0em}
\fbox{\begin{minipage}{0.28\textwidth}
\centering
\vspace{0.1em}
{\Large\bfseries Assignment}
\vspace{0.1em}
\end{minipage}}
\vspace{3.0em}
...
\raggedright
\textbf{Course Code :} SE 401\par
\textbf{Course Title :} System Programming\par
\textbf{Experiment No:} 1
\end{minipage}

\vspace{4em}

{\Large\bfseries \textcolor{green!50!black}{Submitted by}}\par
\vspace{1em}
{\large\bfseries Md Shoriful Islam}\par
ID: 0272220005101010\par
Batch: 60\textsuperscript{th}\par
Program: B.Sc. in CSE\par
City University, Bangladesh

\vspace{1.8em}

{\Large\bfseries \textcolor{green!50!black}{Submitted to}}\par
\vspace{0.3em}
{\large\bfseries Sharmim Akter}\par
{\large\bfseries Lecturer}\par
...
\centering
\vspace{0.45em}
\textbf{Submission Date: 02\textsuperscript{th} May, 2026}
\vspace{0.45em}
\end{minipage}}
\end{center}
\end{titlepage}
